<form action="<?php echo site_url("cargo/edit");?>" method="POST" name="frmCargo" id="idFrmCargo">
<!--sender-->
	<div class="panel-body text-right">
    	<a href="<?php echo base_url("cargo/edit/" . $cargo['cargo']['id']);?>" class="btn btn-default">Edit</a>
	</div>
	...
	<div class="row show-grid printable">
		...
		<div class="col-sm-12">
			<div class="col-sm-12">
				<div class="text-center"><strong>Tracking Number</strong></div>
			</div>
			<div class="col-sm-12">
				<div class="text-center"><img src="<?php echo base_url("barcodegen/barcode.php?text=" . $cargo['cargo']['brandname'] . "-" . $cargo['cargo']['tracking_number']);?>"></div>
			</div>
		</div>
...
<?php $packages = $cargo['package'];?>
<?php $other_fee = $cargo['other_fee'];?>
